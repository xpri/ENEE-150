...
int main()
{
    ...
    {       
        ...
        if (UserInput[0] == '\0')
        {
            printf("Empty input is not valid. Please try again.\n");
            continue;
        }
        ...
        else if (0 == isInteger(tokensOfUserInput[1]) || 0 == isInteger(tokensOfUserInput[2]) || 0 == isInteger(tokensOfUserInput[3]) || 0 == isInteger(tokensOfUserInput[4]))
        {
        ...
        //Clears buffer after each iteration.
